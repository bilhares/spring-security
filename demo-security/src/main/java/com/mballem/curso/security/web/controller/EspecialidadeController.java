...
public class EspecialidadeController {
	...
	public String salvar(Especialidade especialidade, RedirectAttributes attr) {
		...
		attr.addFlashAttribute("sucesso", "deu bom");
		return "redirect:/especialidades";
	}

	@GetMapping("/datatables/server")
	public ResponseEntity<?> getEspecialidades(HttpServletRequest req) {
		return ResponseEntity.ok(service.buscarEspecialidades(req));
	}
